from functions import price_data_from_graph1, price_data_from_graph2, market_data_from_graph1, market_data_from_graph2
import pandas as pd
...
for data_iter in dataa.iterrows():
    graph1_list.append(price_data_from_graph1(data_iter[1]))
    graph2_list.append(price_data_from_graph2(data_iter[1]))
