...
번호가 없는 경우 같은 데이터 원천에서 각기 다른 데이터를 크롤링하였거나
하나의 코드파일에서 크롤링-전처리까지 진행되는 경우입니다.
...
법원경매통계 - 대한민국 법원의 법원경매정보사이트에서 제공하는 경매통계 데이터입니다.
	       전국의 시/도, 시/군/구 소재의 아파트, 토지 등의 물건 분류별 통계자료입니다.

법원등기정보광장 - 법원등기정보광장에서 제공하는 등기 관련 데이터입니다.
		 경매 관련된 등기와 집합건물의 매매등기 평균거래가액 데이터를 크롤링합니다.
